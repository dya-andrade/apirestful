...
public class PersonController {
	...
	@Operation(summary = "Finds People by First Name with Pageable Model", description = "Finds People by First Name with Pageable Model.", tags = {
			"People" }, responses = { @ApiResponse(description = "Success", responseCode = "200", content = {
					...
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content), })
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonByName( // params opcionais e obrigatório
	...
	@Operation(summary = "Finds all People with Pageable Model", description = "Finds all People with Pageable Model.", tags = {
			"People" }, responses = { @ApiResponse(description = "Success", responseCode = "200", content = {
					@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = PersonVO.class))) }),
					...
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content), })
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findAllWithPageableModel( // params opcionais
			@RequestParam(value = "page", defaultValue = "0") Integer page,
			@RequestParam(value = "size", defaultValue = "12") Integer size,
			@RequestParam(value = "direction", defaultValue = "asc") String direction) {
	 ...
	 * 
	 * @Operation(summary = "Finds all People with Pageable", description =
	 * "Finds all People with Pageable.", tags = { "People" }, responses = {
	 * 
	 ...
	 * = @Content), }) public ResponseEntity<Page<PersonVO>> findAllPageable(
	 * 
	 * @RequestParam(value = "page", defaultValue = "0") Integer page,
	 * 
	 * @RequestParam(value = "size", defaultValue = "12") Integer size,
	 ...
	 * Direction.ASC; //operador ternário //retornar desc se for equals, se não asc
	 * 
	 ...
	 * 
	 * @ApiResponse(description = "Internal Error", responseCode = "500", content
	 * = @Content), }) public List<PersonVO> findAll() { return service.findAll(); }
	 */

	@CrossOrigin(origins = { "http://localhost:8080", "https://apirestful.com.br" })
