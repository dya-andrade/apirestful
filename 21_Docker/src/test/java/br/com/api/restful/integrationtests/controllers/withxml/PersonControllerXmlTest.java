...
public class PersonControllerXmlTest extends AbstractIntegrationTest { //TestContainers
	...
	public void testFindAllWithPageableModel() throws JsonMappingException, JsonProcessingException {
		...
		//List<PersonVO> persistedPeople = xmlMapper.readValue(content, new TypeReference<List<PersonVO>>(){});

		PagedModelPersonVO pagedModel = xmlMapper.readValue(content, PagedModelPersonVO.class);
